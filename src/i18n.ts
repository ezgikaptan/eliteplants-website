...
export const translations: Record<Language, TranslationDict> = {
  tr: {
    ...
    shopWholesaleTitle: 'Toptan Sipariş mi Vermek İstiyorsunuz?',
    shopWholesaleDesc: '2.500 adet ve üzeri toptan alımlarda kutu başı 55₺ fiyat avantajından yararlanabilirsiniz (kargo hariç). Detaylar için bizimle iletişime geçin.',
    shopWholesaleCta: 'Toptan Sipariş İçin WhatsApp',
  ...
  en: {
    ...
    shopWholesaleTitle: 'Looking to Order Wholesale?',
    shopWholesaleDesc: 'For bulk orders of 2,500 units or more, you get a discounted price of 55₺ per box (shipping not included). Contact us for details.',
    shopWholesaleCta: 'Wholesale Orders via WhatsApp',
  ...
  es: {
    ...
    shopWholesaleTitle: '¿Desea Realizar un Pedido al por Mayor?',
    shopWholesaleDesc: 'En pedidos al por mayor de 2.500 unidades o más, obtiene un precio especial de 55₺ por caja (envío no incluido). Contáctenos para más detalles.',
    shopWholesaleCta: 'Pedido al por Mayor por WhatsApp',
  ...
  fr: {
    ...
    shopWholesaleTitle: 'Vous Souhaitez Passer une Commande en Gros ?',
    shopWholesaleDesc: 'Pour les commandes en gros de 2 500 unités ou plus, bénéficiez d\'un tarif de 55₺ par boîte (livraison non incluse). Contactez-nous pour plus de détails.',
    shopWholesaleCta: 'Commande en Gros via WhatsApp',
  ...
  de: {
    ...
    shopWholesaleTitle: 'Möchten Sie Großhandelsbestellungen Aufgeben?',
    shopWholesaleDesc: 'Bei Großbestellungen ab 2.500 Einheiten erhalten Sie einen Vorteilspreis von 55₺ pro Schachtel (zzgl. Versand). Kontaktieren Sie uns für Details.',
    shopWholesaleCta: 'Großhandelsbestellung über WhatsApp',
  ...
  ru: {
    ...
    shopWholesaleTitle: 'Хотите Сделать Оптовый Заказ?',
    shopWholesaleDesc: 'При оптовых заказах от 2 500 единиц вы получаете выгодную цену 55₺ за коробку (без учёта доставки). Свяжитесь с нами для получения подробностей.',
    shopWholesaleCta: 'Оптовый Заказ через WhatsApp',
  ...
  zh: {
    ...
    shopWholesaleTitle: '想要批发订购吗？',
    shopWholesaleDesc: '批量订购2,500件及以上时，每盒可享55里拉优惠价（不含运费）。请联系我们了解详情。',
    shopWholesaleCta: '通过WhatsApp批发订购',
    galleryTitle: '照片画廊',
    gallerySub: '我们的生态果园',
  ...
  ja: {
    ...
    shopWholesaleTitle: '卸売注文をご希望ですか？',
    shopWholesaleDesc: '2,500個以上のまとめ買いで、1箱55₺の特別価格でご提供します（送料別）。詳細はお問い合わせください。',
    shopWholesaleCta: 'WhatsAppで卸売注文',
  ...
  ar: {
    ...
    shopWholesaleTitle: 'هل ترغب بطلب كمية بالجملة؟',
    shopWholesaleDesc: 'عند الطلب بكميات 2500 وحدة أو أكثر، تحصل على سعر مخفض 55 ليرة تركية للعلبة (لا يشمل الشحن). تواصل معنا للتفاصيل.',
    shopWholesaleCta: 'طلب بالجملة عبر واتساب',
