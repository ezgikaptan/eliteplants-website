...
export const translations: Record<Language, TranslationDict> = {
  tr: {
    ...
    shopWholesaleTitle: 'Toplu Alımda Otomatik İndirim',
    shopWholesaleDesc: 'Sipariş adediniz arttıkça kutu başı fiyatınız otomatik olarak düşer (kargo hariç). Daha büyük veya özel bir sipariş için bizimle iletişime geçin.',
  ...
  en: {
    ...
    shopWholesaleTitle: 'Automatic Bulk Discount',
    shopWholesaleDesc: 'The price per box automatically drops as your order quantity increases (shipping not included). For larger or custom orders, contact us.',
  ...
  es: {
    ...
    shopWholesaleTitle: 'Descuento Automático por Volumen',
    shopWholesaleDesc: 'El precio por caja disminuye automáticamente a medida que aumenta la cantidad de su pedido (envío no incluido). Para pedidos más grandes o solicitudes especiales, contáctenos.',
  ...
  fr: {
    ...
    shopWholesaleTitle: 'Remise Automatique sur le Volume',
    shopWholesaleDesc: 'Le prix par boîte diminue automatiquement à mesure que votre quantité commandée augmente (livraison non incluse). Pour les commandes plus importantes ou les demandes spéciales, contactez-nous.',
  ...
  de: {
    ...
    shopWholesaleTitle: 'Automatischer Mengenrabatt',
    shopWholesaleDesc: 'Der Preis pro Schachtel sinkt automatisch mit steigender Bestellmenge (zzgl. Versand). Für größere oder individuelle Bestellungen kontaktieren Sie uns.',
  ...
  ru: {
    ...
    shopWholesaleTitle: 'Автоматическая Скидка за Объём',
    shopWholesaleDesc: 'Цена за коробку автоматически снижается с увеличением количества заказа (без учёта доставки). Для более крупных или особых заказов свяжитесь с нами.',
  ...
  zh: {
    ...
    shopWholesaleTitle: '批量自动折扣',
    shopWholesaleDesc: '每盒价格会随订购数量增加而自动降低（不含运费）。如需更大批量或特殊需求的订单，请联系我们。',
  ...
  ja: {
    ...
    shopWholesaleTitle: '数量に応じた自動割引',
    shopWholesaleDesc: 'ご注文数量が増えるほど、1箱あたりの価格が自動的に下がります（送料別）。より大口のご注文や特別なご要望はお問い合わせください。',
  ...
  ar: {
    ...
    shopWholesaleTitle: 'خصم تلقائي حسب الكمية',
    shopWholesaleDesc: 'ينخفض سعر العلبة تلقائياً كلما زادت كمية طلبك (لا يشمل الشحن). للطلبات الأكبر أو الخاصة، تواصل معنا.',
