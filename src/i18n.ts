...
export interface TranslationDict {
  ...
  productsKaraberryName: string;
  productsAlberryName: string;
  productsGokberryName: string;
  ...
  shopTitle: string;
  shopSub: string;
  shopPackageLabel: string;
  shopComingSoonNote: string;
  shopPriceUnit: string;
  shopShippingNote: string;
  shopShippingDisclaimer: string;
  shopAddToCart: string;
  shopCartTitle: string;
  shopCartEmpty: string;
  shopCartSubtotal: string;
  shopCartRemoveLabel: string;
  shopOrderWhatsapp: string;
  shopWholesaleTitle: string;
  shopWholesaleDesc: string;
  shopWholesaleCta: string;
  shopTiersQtyLabel: string;
  shopTiersPriceLabel: string;
...
export const translations: Record<Language, TranslationDict> = {
  tr: {
    ...
    heroExplore: 'Meyve Bahçemizi Keşfedin',
    ...
    productsKaraberryName: 'Böğürtlen',
    productsAlberryName: 'Ahududu',
    productsGokberryName: 'Mavi Yemiş',
    aboutTitle: 'Doğanın Eseri, Toplandığı Gibi',
    ...
    navShop: 'Online Satış',
    shopTitle: 'Taze Meyvelerimizi Sipariş Verin',
    shopSub: 'Organik olarak yetiştirdiğimiz meyvelerimizi doğrudan bahçemizden sofranıza ulaştırıyoruz. Sepetinize ekleyin, WhatsApp üzerinden siparişinizi tamamlayın.',
    shopPackageLabel: '125g Kutu',
    shopComingSoonNote: 'Bu çeşit için online satış yakında başlıyor.',
    shopPriceUnit: '/ 125g',
    shopShippingNote: '+ Kargo',
    shopShippingDisclaimer: 'Fiyatlara kargo ücreti dahil değildir.',
    shopAddToCart: 'Sepete Ekle',
    shopCartTitle: 'Sepetiniz',
    shopCartEmpty: 'Sepetiniz henüz boş.',
    shopCartSubtotal: 'Ara Toplam',
    shopCartRemoveLabel: 'Sepetten Çıkar',
    shopOrderWhatsapp: 'WhatsApp\'tan Sipariş Ver',
    shopWholesaleTitle: 'Adet Bazlı Fiyat Kademeleri',
    shopWholesaleDesc: 'Sipariş adediniz arttıkça kutu başı fiyatınız aşağıdaki tabloya göre otomatik düşer (kargo hariç). Tablodaki adetlerin dışında daha büyük veya özel bir sipariş için bizimle iletişime geçin.',
    shopWholesaleCta: 'Özel Sipariş İçin WhatsApp',
    shopTiersQtyLabel: 'Adet',
    shopTiersPriceLabel: 'Birim Fiyat',
  ...
  en: {
    ...
    heroExplore: 'Explore Our Orchard',
    ...
    productsKaraberryName: 'Blackberry',
    productsAlberryName: 'Raspberry',
    productsGokberryName: 'Blueberry',
    aboutTitle: 'Nature\'s Work, Freshly Picked',
    ...
    varietiesSoon: 'Soon',
    navShop: 'Shop',
    shopTitle: 'Order Our Fresh Berries',
    shopSub: 'We deliver our organically grown fruit straight from our garden to your table. Add to your cart and complete your order via WhatsApp.',
    shopPackageLabel: '125g Box',
    shopComingSoonNote: 'Online sales for this variety are launching soon.',
    shopPriceUnit: '/ 125g',
    shopShippingNote: '+ Shipping',
    shopShippingDisclaimer: 'Prices do not include shipping.',
    shopAddToCart: 'Add to Cart',
    shopCartTitle: 'Your Cart',
    shopCartEmpty: 'Your cart is empty.',
    shopCartSubtotal: 'Subtotal',
    shopCartRemoveLabel: 'Remove from cart',
    shopOrderWhatsapp: 'Order via WhatsApp',
    shopWholesaleTitle: 'Volume Price Tiers',
    shopWholesaleDesc: 'The price per box automatically drops as your order quantity increases, per the table below (shipping not included). For orders outside this table or special requests, contact us.',
    shopWholesaleCta: 'WhatsApp for a Custom Order',
    shopTiersQtyLabel: 'Quantity',
    shopTiersPriceLabel: 'Unit Price',
  ...
  es: {
    ...
    heroExplore: 'Explore Nuestro Huerto',
    heroStatBahceTitle: '50+ Acres',
    ...
    productsKaraberryName: 'Zarzamora',
    productsAlberryName: 'Frambuesa',
    productsGokberryName: 'Arándano',
    aboutTitle: 'Obra de la Naturaleza, Recién Cosechada',
    ...
    navShop: 'Tienda',
    shopTitle: 'Pida Nuestras Moras Frescas',
    shopSub: 'Entregamos nuestra fruta cultivada orgánicamente directamente desde nuestro huerto hasta su mesa. Añádala a su carrito y complete su pedido por WhatsApp.',
    shopPackageLabel: 'Caja de 125g',
    shopComingSoonNote: 'La venta online de esta variedad comenzará pronto.',
    shopPriceUnit: '/ 125g',
    shopShippingNote: '+ Envío',
    shopShippingDisclaimer: 'Los precios no incluyen el envío.',
    shopAddToCart: 'Añadir al Carrito',
    shopCartTitle: 'Su Carrito',
    shopCartEmpty: 'Su carrito está vacío.',
    shopCartSubtotal: 'Subtotal',
    shopCartRemoveLabel: 'Quitar del carrito',
    shopOrderWhatsapp: 'Pedir por WhatsApp',
    shopWholesaleTitle: 'Niveles de Precio por Volumen',
    shopWholesaleDesc: 'El precio por caja disminuye automáticamente a medida que aumenta la cantidad de su pedido, según la tabla siguiente (envío no incluido). Para pedidos fuera de esta tabla o solicitudes especiales, contáctenos.',
    shopWholesaleCta: 'WhatsApp para Pedido Especial',
    shopTiersQtyLabel: 'Cantidad',
    shopTiersPriceLabel: 'Precio Unitario',
  ...
  fr: {
    ...
    productsKaraberryName: 'Mûre',
    productsAlberryName: 'Framboise',
    productsGokberryName: 'Myrtille',
    aboutTitle: 'Une Œuvre de la Nature, Fraîchement Cueillie',
    ...
    navShop: 'Boutique',
    shopTitle: 'Commandez Nos Fruits Frais',
    shopSub: 'Nous livrons nos fruits cultivés biologiquement directement de notre jardin à votre table. Ajoutez-les à votre panier et finalisez votre commande via WhatsApp.',
    shopPackageLabel: 'Boîte de 125g',
    shopComingSoonNote: 'La vente en ligne de cette variété débutera bientôt.',
    shopPriceUnit: '/ 125g',
    shopShippingNote: '+ Livraison',
    shopShippingDisclaimer: 'Les prix n\'incluent pas les frais de livraison.',
    shopAddToCart: 'Ajouter au Panier',
    shopCartTitle: 'Votre Panier',
    shopCartEmpty: 'Votre panier est vide.',
    shopCartSubtotal: 'Sous-total',
    shopCartRemoveLabel: 'Retirer du panier',
    shopOrderWhatsapp: 'Commander via WhatsApp',
    shopWholesaleTitle: 'Paliers de Prix par Volume',
    shopWholesaleDesc: 'Le prix par boîte diminue automatiquement à mesure que votre quantité commandée augmente, selon le tableau ci-dessous (livraison non incluse). Pour les commandes en dehors de ce tableau ou les demandes spéciales, contactez-nous.',
    shopWholesaleCta: 'WhatsApp pour Commande Spéciale',
    shopTiersQtyLabel: 'Quantité',
    shopTiersPriceLabel: 'Prix Unitaire',
  ...
  de: {
    ...
    heroExplore: 'Erkunden Sie Unseren Obstgarten',
    ...
    productsKaraberryName: 'Brombeere',
    productsAlberryName: 'Himbeere',
    productsGokberryName: 'Blaubeere',
    aboutTitle: 'Ein Werk der Natur, Frisch Geerntet',
    ...
    navShop: 'Shop',
    shopTitle: 'Bestellen Sie Unsere Frischen Beeren',
    shopSub: 'Wir liefern unser biologisch angebautes Obst direkt aus unserem Garten auf Ihren Tisch. Legen Sie es in den Warenkorb und schließen Sie Ihre Bestellung über WhatsApp ab.',
    shopPackageLabel: '125g Schachtel',
    shopComingSoonNote: 'Der Online-Verkauf dieser Sorte startet in Kürze.',
    shopPriceUnit: '/ 125g',
    shopShippingNote: '+ Versand',
    shopShippingDisclaimer: 'Die Preise verstehen sich zuzüglich Versandkosten.',
    shopAddToCart: 'In den Warenkorb',
    shopCartTitle: 'Ihr Warenkorb',
    shopCartEmpty: 'Ihr Warenkorb ist noch leer.',
    shopCartSubtotal: 'Zwischensumme',
    shopCartRemoveLabel: 'Aus dem Warenkorb entfernen',
    shopOrderWhatsapp: 'Über WhatsApp Bestellen',
    shopWholesaleTitle: 'Mengenrabattstufen',
    shopWholesaleDesc: 'Der Preis pro Schachtel sinkt automatisch mit steigender Bestellmenge gemäß der folgenden Tabelle (zzgl. Versand). Für Bestellungen außerhalb dieser Tabelle oder Sonderwünsche kontaktieren Sie uns.',
    shopWholesaleCta: 'WhatsApp für Sonderbestellung',
    shopTiersQtyLabel: 'Menge',
    shopTiersPriceLabel: 'Stückpreis',
  ...
  ru: {
    ...
    heroExplore: 'Исследуйте Наш Фруктовый Сад',
    ...
    productsKaraberryName: 'Ежевика',
    productsAlberryName: 'Малина',
    productsGokberryName: 'Голубика',
    aboutTitle: 'Дар Природы, Свежий с Ветки',
    ...
    varietiesSoon: 'Скоро',
    navShop: 'Магазин',
    shopTitle: 'Закажите Наши Свежие Ягоды',
    shopSub: 'Мы доставляем органически выращенные фрукты прямо из нашего сада на ваш стол. Добавьте в корзину и оформите заказ через WhatsApp.',
    shopPackageLabel: 'Коробка 125г',
    shopComingSoonNote: 'Онлайн-продажа этого сорта скоро начнется.',
    shopPriceUnit: '/ 125г',
    shopShippingNote: '+ Доставка',
    shopShippingDisclaimer: 'Цены не включают стоимость доставки.',
    shopAddToCart: 'В Корзину',
    shopCartTitle: 'Ваша Корзина',
    shopCartEmpty: 'Ваша корзина пуста.',
    shopCartSubtotal: 'Промежуточный итог',
    shopCartRemoveLabel: 'Удалить из корзины',
    shopOrderWhatsapp: 'Заказать через WhatsApp',
    shopWholesaleTitle: 'Ценовые Уровни по Объёму',
    shopWholesaleDesc: 'Цена за коробку автоматически снижается с увеличением количества заказа согласно таблице ниже (без учёта доставки). Для заказов вне этой таблицы или особых запросов свяжитесь с нами.',
    shopWholesaleCta: 'WhatsApp для Особого Заказа',
    shopTiersQtyLabel: 'Количество',
    shopTiersPriceLabel: 'Цена за единицу',
  ...
  zh: {
    ...
    productsKaraberryName: '黑莓',
    productsAlberryName: '树莓',
    productsGokberryName: '蓝莓',
    aboutTitle: '大自然的杰作，新鲜采摘',
    aboutCursive: '我们的故事',
    ...
    navShop: '商店',
    shopTitle: '订购我们的新鲜浆果',
    shopSub: '我们将有机种植的水果直接从果园送到您的餐桌。加入购物车，通过WhatsApp完成订购。',
    shopPackageLabel: '125克装',
    shopComingSoonNote: '该品种的在线销售即将开始。',
    shopPriceUnit: '/ 125克',
    shopShippingNote: '+ 运费',
    shopShippingDisclaimer: '价格不包含运费。',
    shopAddToCart: '加入购物车',
    shopCartTitle: '您的购物车',
    shopCartEmpty: '您的购物车还是空的。',
    shopCartSubtotal: '小计',
    shopCartRemoveLabel: '从购物车中移除',
    shopOrderWhatsapp: '通过WhatsApp订购',
    shopWholesaleTitle: '批量价格阶梯',
    shopWholesaleDesc: '每盒价格会根据下表随订购数量增加而自动降低（不含运费）。如需超出此表的订单或特殊需求，请联系我们。',
    shopWholesaleCta: '通过WhatsApp咨询特殊订单',
    shopTiersQtyLabel: '数量',
    shopTiersPriceLabel: '单价',
    galleryTitle: '照片画廊',
    gallerySub: '我们的生态果园',
  ...
  ja: {
    ...
    productsKaraberryName: 'ブラックベリー',
    productsAlberryName: 'ラズベリー',
    productsGokberryName: 'ブルーベリー',
    aboutTitle: '自然の恵み、収穫したてのまま',
    aboutCursive: '私たちの歩み',
    ...
    varietiesSoon: '近日公開',
    navShop: 'ショップ',
    shopTitle: '新鮮なベリーをご注文ください',
    shopSub: '有機栽培のフルーツを農園から直接お届けします。カートに追加してWhatsAppでご注文を完了してください。',
    shopPackageLabel: '125gパック',
    shopComingSoonNote: 'この品種のオンライン販売は近日開始予定です。',
    shopPriceUnit: '/ 125g',
    shopShippingNote: '+ 送料',
    shopShippingDisclaimer: '価格に送料は含まれません。',
    shopAddToCart: 'カートに追加',
    shopCartTitle: 'カート',
    shopCartEmpty: 'カートはまだ空です。',
    shopCartSubtotal: '小計',
    shopCartRemoveLabel: 'カートから削除',
    shopOrderWhatsapp: 'WhatsAppで注文する',
    shopWholesaleTitle: '数量別価格段階',
    shopWholesaleDesc: 'ご注文数量が増えるほど、下記表に従って1箱あたりの価格が自動的に下がります（送料別）。表の範囲外のご注文や特別なご要望はお問い合わせください。',
    shopWholesaleCta: '特別注文についてWhatsAppで相談',
    shopTiersQtyLabel: '数量',
    shopTiersPriceLabel: '単価',
  ...
  ar: {
    ...
    productsKaraberryName: 'توت العليق',
    productsAlberryName: 'توت أحمر',
    productsGokberryName: 'توت أزرق',
    aboutTitle: 'هدية الطبيعة، طازجة كما تُقطف',
    aboutCursive: 'قصتنا',
    ...
    navShop: 'المتجر',
    shopTitle: 'اطلب توتنا الطازج',
    shopSub: 'نوصل ثمارنا العضوية مباشرة من بستاننا إلى مائدتكم. أضف إلى سلتك وأكمل طلبك عبر واتساب.',
    shopPackageLabel: 'علبة 125 غرام',
    shopComingSoonNote: 'سيبدأ البيع عبر الإنترنت لهذا الصنف قريباً.',
    shopPriceUnit: '/ 125 غ',
    shopShippingNote: '+ الشحن',
    shopShippingDisclaimer: 'الأسعار لا تشمل رسوم الشحن.',
    shopAddToCart: 'أضف إلى السلة',
    shopCartTitle: 'سلتك',
    shopCartEmpty: 'سلتك فارغة حالياً.',
    shopCartSubtotal: 'المجموع الفرعي',
    shopCartRemoveLabel: 'إزالة من السلة',
    shopOrderWhatsapp: 'اطلب عبر واتساب',
    shopWholesaleTitle: 'مستويات الأسعار حسب الكمية',
    shopWholesaleDesc: 'ينخفض سعر العلبة تلقائياً كلما زادت كمية طلبك، وفقاً للجدول أدناه (لا يشمل الشحن). للطلبات خارج هذا الجدول أو الطلبات الخاصة، تواصل معنا.',
    shopWholesaleCta: 'واتساب لطلب خاص',
    shopTiersQtyLabel: 'الكمية',
    shopTiersPriceLabel: 'سعر الوحدة',
